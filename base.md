基于后面"""主题 ....... """部分中的内容,生成cheatsheet, 其可能是链接,或者文本,如果是链接, 需要你分析链接内容和其页面上的关联内容
