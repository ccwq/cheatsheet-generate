...
### GitHub Copilot CLI
- 安装：`copilot plugin install ./cli-anything-plugin`
- 常用命令：`/cli-anything:cli-anything`、`/cli-anything:refine`、`/cli-anything:validate`
- 插件安装后重启会话即可使用
...
- v0.2.0 已通过 1,839+ 测试，覆盖 16 个应用，跨创意、生产力、通信等多元领域
